...
export class ButtonComponent implements OnInit {
  ...
  impactClasses: Record<ButtonProps['tone'], Record<ButtonProps['impact'], string>> = {
    ...
    info: {
      bold: 'bg-azul-500 text-white hover:bg-azul-600 focus-visible:ring-azul-500',
      light: 'bg-azul-500/20 text-azul-600 hover:bg-azul-500/30 focus-visible:ring-azul-500',
      none: 'bg-transparent text-azul-600 hover:bg-azul-500/10 focus-visible:ring-azul-500',
    },
    light: {
